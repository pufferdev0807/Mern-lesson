        ...
        >
          <Container className="col-md-8 col-lg-8 col-sm-10">
            ...
            <div className="fs-5-2 text-center text-white mt-2">
                ...
                <Col lg={12} md={12} sm={12}>
                  {isLoding == true ? (
                    <Button className="w-100 p-3 bg-primary-2 border border-0 d-flex align-items-center justify-content-center" disabled>
                      <div>Login with Email</div><Spinner className="ms-2" animation="grow" />
                    </Button>
                  ) : (
                    <Button className="w-100 bg-white p-3 d-flex align-items-center justify-content-center text-primary-1 border border-0 fw-bold border-none register-btn" onClick={Login}>
              ...
              <div className="fs-6 text-center text-white mb-4">or Login with</div>
              ...
              <div className="fs-6 text-center text-white mt-5">By signing in or creating an account, you agree with your <div className="d-flex align-items-center justify-content-center"><Link to="/" className="nav-link text-white fw-bold px-2">Terms & Conditions</Link> and <Link to="/" className="nav-link text-white fw-bold px-2">Privacy Statement</Link></div></div>
            </Form>
          </Container>
        </Col>
        <Col
